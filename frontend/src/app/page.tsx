...
export default function Home() {
  ...
  useEffect(() => {
    const messages = [
      ...
      "Ranking by premium potential...",
      "Validating trademark risks...",
      "Generating variations...",
      "Applying linguistic filters...",
  ...
  const handleHunt = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setProgress(13); // Completed
        toast.success(`Hunt Successful! ${data.totalAvailable} available, Top 30 curated.`);
      } else {
    ...
    <div className="container mx-auto px-6 py-12 lg:py-24 max-w-7xl">
      ...
      <div className="flex flex-col items-center text-center mb-16 lg:mb-24">
        ...
        <motion.p 
          ...
          className="text-lg lg:text-xl text-white/50 max-w-2xl mb-12"
        >
        ...
        <motion.div
          ...
          className="w-full max-w-lg mb-6 group relative"
        >
          <div className="flex items-center gap-3 px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus-within:border-accent/40 transition-colors backdrop-blur-md">
            ...
            />
            <div className="text-[10px] text-white/30 border border-white/10 px-2 py-0.5 rounded uppercase tracking-wider">
              BYOK
            </div>
          </div>
          <p className="text-[10px] text-white/20 mt-2 text-left px-1">
            Don't have a key? Get one free from <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-accent/50 hover:text-accent underline transition-colors">Google AI Studio</a>.
          </p>
        </motion.div>
        ...
        {isLoading ? (
          ...
          >
            ...
            <div className="max-w-md w-full">
              ...
              <motion.p
                ...
                animate={{ opacity: 1, y: 0 }}
                className="mt-4 text-sm text-center text-accent/80 font-mono tracking-wide"
              >
                {statusMessage}
              </motion.p>
            </div>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-white/5 pb-8">
              <div>
                <h2 className="text-3xl font-black text-white mb-2">Elite 30 Shortlist</h2>
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-col items-center md:items-start gap-2">
          ...
          <p className="text-gray-500 text-xs max-w-xs text-center md:text-left leading-relaxed">
            Curating high-alpha digital assets. Turning keywords into premium real estate.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <p className="text-[11px] text-gray-600 font-medium">
            &copy; {currentYear} DomainHunt. All Rights Reserved.
          </p>
        </div>
